...
func (o *DBSearchOSs) AddFlags(flags clio.FlagSet) {
	flags.StringArrayVarP(&o.OSs, "distro", "", "refine to results with the given operating system (format: 'name', 'name@version', 'name@maj.min', 'name@codename') (for v6+ schemas only)") // consistent with grype flag today
}
